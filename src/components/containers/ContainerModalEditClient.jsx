...
export default function ContainerModalEditClient({ register, errors, handleCepChange, isCepFilled, handleInputChange, client }) {
  return (
    <div className='flex flex-col gap-2'>
      ...
      <AlternativeInput
        ...
        input2={{
          ...
          defaultValue: client ? client.neighborhood : ''
        }}
        register={register}
      />
      <GenericInput
      ...
      <GenericInput
        ...
        register={register}
        value={client ? client.complement : ''}
        disabled={!isCepFilled}
      />
      ...
      <AlternativeInput
        ...
        input2={{
          ...
          pattern: "[A-Za-z]{2}",
          disabled: !isCepFilled,
          defaultValue: client ? client.state : ''
        }}
        register={register}
      />
    </div>
