...
export default function handleSelectIconType(value) {
  if (value === 'paid') {
    return <FileCheck size={48} stroke="#1FA7AF" strokeWidth={1} />
  } else if (value === 'pending') {
    return <FileWarning size={48} stroke="#C5A605" strokeWidth={1} />
  } else if (value === 'overdue') {
    return <FileX size={48} stroke="#971D1D" strokeWidth={1} />
